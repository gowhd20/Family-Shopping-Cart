 ...
 */
public class AddAcceptors extends AsyncTask<Void, Void, Void> {
    ...
    public AddAcceptors(Context CONTEXT, JsonObject OBJ) {
        context = CONTEXT;
        dialog = new ProgressDialog(context);
        url = "https://black-function-122210.appspot.com/ms/family/" + FamilyGroupActivity.familyName_static + "/requests";
        obj = OBJ;
    }
    ...
    public void putRequest(String url, Object json, final HttpCallback cb) throws IOException {
